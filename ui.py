...
class CreateClientWindow(Toplevel, CenterWidgetMixin):
    ...
    def build(self):
        ...
        Label(frame, text="DNI (8 ints)").grid(row=0, column=0)
...
class EditClientWindow(Toplevel, CenterWidgetMixin):
    ...
    def update_client(self):
        ...
        db.Clientes.editar(self.dni.get(), self.nombre.get(), self.apellido.get())
        self.close()
...
class MainWindow(Tk, CenterWidgetMixin):
    ...
    def build(self):
        ...
        Button(frame, text="Modificar", command=self.edit).grid(row=1, column=1)
